...
public class Crack101NoSpace {

    static void addToDic(Character charFromLine, HashMap<Character, Double> objHashMap){

        int tempForCheck = charFromLine;
        //System.out.println(tempForCheck);
        if (tempForCheck == 32) {
            return;
        }
    ...
    public static void main(String[] args){
        ...
        try {
            FileOutputStream fos = new FileOutputStream("FrequencyWitoutSpace.txt");
